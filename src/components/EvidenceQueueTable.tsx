...
export function EvidenceQueueTable({ items, projectNames }: Props) {
  ...
  if (visible.length === 0) {
    return (
      <div className="px-6 py-8 text-center text-sm text-[#131218]/30 italic">
  ...
  return (
    <>
      ...
      {selected.size > 0 && (
        <div className="px-6 py-2.5 bg-[#131218] flex items-center justify-between">
          ...
          <button
            ...
            disabled={isPending}
            className="inline-flex items-center gap-1.5 text-[10px] font-bold bg-[#B2FF59] text-[#131218] px-3 py-1.5 rounded-full uppercase tracking-widest hover:bg-[#9ee84a] transition-colors disabled:opacity-50"
          >
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-[#EFEFEA]">
            ...
            <th className="text-left px-2 py-3 text-[10px] font-bold text-[#131218]/30 uppercase tracking-widest">Evidence</th>
      ...
      {visible.length > 5 && selected.size < visible.length && (
        <div className="px-6 py-3 border-t border-[#EFEFEA] flex items-center justify-between">
          <button
            onClick={toggleAll}
            className="text-[10px] font-bold text-[#131218]/30 hover:text-[#131218] transition-colors uppercase tracking-widest"
          >
          ...
          {selected.size > 0 && (
            <button
              onClick={handleBatchApprove}
              disabled={isPending}
              className="text-[10px] font-bold bg-[#B2FF59] text-[#131218] px-3 py-1.5 rounded-full uppercase tracking-widest hover:bg-[#9ee84a] transition-colors disabled:opacity-50"
            >

    ...
    <div className="bg-white rounded-2xl border border-[#E0E0D8] overflow-hidden">
      ...
      <div className="px-6 py-5">
        ...
        <div className="relative">
          {/* Track line */}
          <div className="absolute left-[7px] top-2 bottom-2 w-px bg-[#E0E0D8]" />
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] font-bold text-[#131218]/25 uppercase tracking-widest mt-0.5">
                      {item.date}
                    </p>
                    {item.note && (
                      <p className="text-xs text-[#131218]/40 mt-1 leading-snug">
                        {item.note}
                      </p>
                    )}
                  </div>

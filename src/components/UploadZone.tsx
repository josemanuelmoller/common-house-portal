  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E0E0D8] overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-[#EFEFEA]">
        <p className="text-[10px] font-bold text-[#131218]/30 uppercase tracking-widest">Upload Document</p>
        <p className="text-sm font-bold text-[#131218] tracking-tight mt-0.5">Share a file with Common House</p>
      </div>
      ...
      <div className="px-6 py-5 space-y-4">
        ...
        {/* Folder selector */}
        <div>
          <p className="text-[10px] font-bold text-[#131218]/30 uppercase tracking-widest mb-2">Save to folder</p>
              ...
              <button
                ...
                className={`flex flex-col items-center gap-1.5 px-3 py-3 rounded-xl border text-center transition-all ${
                  selectedFolder === f.name
                    ? "border-[#131218] bg-[#131218] text-white"
                    : "border-[#E0E0D8] hover:border-[#131218]/30 text-[#131218]/50"
                }`}
              >
        ...
        <div
          ...
          className={`relative flex flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed px-6 py-10 cursor-pointer transition-all ${
            dragOver
              ? "border-[#B2FF59] bg-[#B2FF59]/10"
              : isPending
              ? "border-[#131218]/20 bg-[#EFEFEA]/50 cursor-wait"
              : "border-[#E0E0D8] hover:border-[#131218]/30 hover:bg-[#EFEFEA]/30"
          }`}
        >
          <input
            ref={inputRef}
          ...
          {isPending ? (
            <>
              <div className="w-8 h-8 border-2 border-[#131218]/20 border-t-[#131218] rounded-full animate-spin" />
              <p className="text-sm font-semibold text-[#131218]/50">Uploading to {selectedFolder}...</p>
            </>
          ) : (
            <>
              <div className="w-10 h-10 bg-[#EFEFEA] rounded-xl flex items-center justify-center text-xl">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-[#131218]/30 mt-1">
        ...
        {uploaded && (
          <div className="flex items-center gap-3 bg-[#B2FF59]/20 border border-[#B2FF59] rounded-xl px-4 py-3">
            ...
            <a
              ...
              className="text-[10px] font-bold text-[#131218]/50 hover:text-[#131218] uppercase tracking-widest transition-colors"
            >
              Ver →
            </a>
          </div>

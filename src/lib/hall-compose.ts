...
- welcome_note: address the COUNTERPART ORGANIZATION (not a specific person — multiple people from the same org may access the Hall over time). Use plural / collective form (e.g. "your team", "you" plural, "we welcome <Org>"). Anchor to the actual triggering event (meeting date, format). Frame as a shared workspace. Avoid third-person blurbs like "the two organizations" or "this partnership" — that reads as press-release copy. Tone: warm but operational. Max 2 sentences. WRITE THE FINAL OUTPUT IN THE SAME LANGUAGE AS THE SOURCE TRANSCRIPT. Example shape (in English): "Welcome to the shared space between <OrgName> and <CH/us>. We'll keep updating <what>, <what>, <what> as the work moves." Translate this shape to the source language as needed.

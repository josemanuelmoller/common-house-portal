...
const ES: Record<string, string> = {
  ...
  "toast.saved": "Guardado", "toast.uploaded": "Documento subido",
  // panel de detalle
  "detail.open": "Abrir detalle", "detail.task": "Tarea", "detail.deliverable": "Entregable",
  "detail.save": "Guardar", "detail.cancel": "Cancelar", "detail.close": "Cerrar",
  "detail.readonly": "Tu rol no puede editar estos campos.", "detail.gone": "Ya no existe.",
  "detail.unassigned": "Sin asignar", "detail.none": "Ninguno", "detail.noPhase": "Sin fase",
  "field.title": "Título", "field.description": "Descripción", "field.owner": "Responsable", "field.side": "Parte responsable",
  "field.deliverable": "Entregable", "field.dependsOn": "Depende de", "field.due": "Fecha",
  "field.phase": "Fase", "field.progress": "Avance", "field.state": "Estado",
  "field.closure": "Cierre", "field.evidence": "Evidencia", "field.acceptedBy": "Aceptado por",
  "mat.uploading": "Subiendo…",
  // prompts
...
const EN: Record<string, string> = {
  ...
  "toast.saved": "Saved", "toast.uploaded": "Document uploaded",
  "detail.open": "Open details", "detail.task": "Task", "detail.deliverable": "Deliverable",
  "detail.save": "Save", "detail.cancel": "Cancel", "detail.close": "Close",
  "detail.readonly": "Your role can't edit these fields.", "detail.gone": "No longer exists.",
  "detail.unassigned": "Unassigned", "detail.none": "None", "detail.noPhase": "No phase",
  "field.title": "Title", "field.description": "Description", "field.owner": "Owner", "field.side": "Responsible party",
  "field.deliverable": "Deliverable", "field.dependsOn": "Depends on", "field.due": "Due",
  "field.phase": "Phase", "field.progress": "Progress", "field.state": "Status",
  "field.closure": "Closure", "field.evidence": "Evidence", "field.acceptedBy": "Accepted by",

    ...
    <div className="flex min-h-screen bg-[#EFEFEA]">
      ...
      <main className="flex-1 ml-60">
        <div className="border-b border-[#E0E0D8] bg-white px-8 py-6">
          <p className="text-[10px] font-bold text-[#131218]/30 uppercase tracking-widest mb-1">Portfolio</p>
          <h1 className="text-2xl font-bold text-[#131218] tracking-tight">Investors</h1>
        </div>

...
export default async function KnowledgePage() {
  ...
  for (const e of allEvidence) {
    ...
    if (e.reusability === "Reusable" && e.validationStatus === "Validated") evidenceByProject[pid].reusable++;
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="bg-white border-b border-[#E0E0D8] px-8 py-6">
          <div className="flex items-end justify-between">
            <div>
              ...
              <h1 className="text-3xl font-bold text-[#131218] tracking-tight">Knowledge System</h1>
              <p className="text-sm text-[#131218]/40 mt-1">Aprendizajes, insights y conocimiento acumulado</p>
            </div>
            <p className="text-xs text-[#131218]/30 font-medium pb-1">
              {assets.length} knowledge assets · {reusable.length} reusable evidence
            </p>
          </div>
        </div>
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <MetricCard label="Reusable Evidence" value={reusable.length}  color="green" />
            <MetricCard label="Projects"          value={projects.length}  />
            <MetricCard label="Total Evidence"    value={allEvidence.length} />
          </div>

          {/* Evidence breakdown per project */}
          <div className="bg-white rounded-2xl border border-[#E0E0D8] overflow-hidden">
            <div className="h-1 bg-[#B2FF59]" />
            <div className="px-6 py-4 border-b border-[#EFEFEA]">
              <h2 className="text-sm font-bold text-[#131218] tracking-tight">Knowledge Built — by Project</h2>
              <p className="text-xs text-[#131218]/40 mt-0.5">Cuánta evidence se ha procesado y cuánto conocimiento reutilizable se ha generado</p>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-[#E0E0D8] overflow-hidden">
            ...
            <div className="px-6 py-4 border-b border-[#EFEFEA]">
              ...
              <p className="text-xs text-[#131218]/40 mt-0.5">Activos de conocimiento construidos y actualizados por el OS</p>
            </div>
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#EFEFEA]">
          ...
          <div className="bg-white rounded-2xl border border-[#E0E0D8] overflow-hidden">
            ...
            <div className="px-6 py-4 border-b border-[#EFEFEA]">
              ...
              <p className="text-xs text-[#131218]/40 mt-0.5">Evidence validada con potencial de reutilización cross-project</p>
            </div>
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[#EFEFEA]">
              ...
              <tbody className="divide-y divide-[#EFEFEA]">
                ...
                {reusable.length === 0 && (
                  <tr>
                    <td colSpan={5} className="px-6 py-8 text-center text-sm text-[#131218]/30">
                      No reusable evidence validated yet.
                    </td>
                  </tr>
                )}
              </tbody>
            ...
            <div className="px-6 py-3 border-t border-[#EFEFEA]">
              <p className="text-[10px] text-[#131218]/25 font-bold uppercase tracking-widest">COUNT {reusable.length}</p>
            </div>
          </div>
